        ...
        <div className="mt-20 space-y-12">
            <div className="flex flex-col items-center gap-4 text-center">
                ...
                <p className="max-w-xl text-muted">
                    De Sonatel Academy &agrave; Saraya Tech, voici les &eacute;tapes cl&eacute;s de mon &eacute;volution constante.
                </p>
            </div>
            ...
            >
                ...
                <div className="space-y-12">
                    {experiences.map((exp, index) => (
                        ...
                        >
                            {/* Dot on Line */}
                            <div className="absolute left-8 -translate-x-1/2 rounded-full border-4 border-background bg-secondary p-1 text-background sm:left-1/2">
                                <Briefcase size={16} />
                            </div>

                            {/* Content */}
                            <div className="ml-16 sm:ml-0 sm:w-1/2 sm:px-12">
                                <div className={`rounded-2xl border border-border bg-surface p-6 shadow-xl transition-all hover:border-secondary/30 hover:shadow-secondary/5 ${index % 2 === 0 ? "text-left" : "sm:text-right"
                                    }`}>
                                    <div className={`flex flex-col gap-2 ${index % 2 === 0 ? "" : "sm:items-end"}`}>
                                    ...
                                    <ul className={`mt-4 space-y-2 ${index % 2 === 0 ? "" : "sm:items-end"}`}>
